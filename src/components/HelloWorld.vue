...
.hello
  ...
  ul
    ...
    li #[a(href="https://forum.vuejs.org" target="_blank" rel="noopener") Forum]
  ...
  ul
    ...
    li #[a(href="https://vuex.vuejs.org" target="_blank" rel="noopener") vuex]
    li #[a(href="https://github.com/vuejs/vue-devtools#vue-devtools" target="_blank" rel="noopener") vue-devtools]
    li #[a(href="https://vue-loader.vuejs.org" target="_blank" rel="noopener") vue-loader]
    li #[a(href="https://github.com/vuejs/awesome-vue" target="_blank" rel="noopener") awesome-vue]
</template>
